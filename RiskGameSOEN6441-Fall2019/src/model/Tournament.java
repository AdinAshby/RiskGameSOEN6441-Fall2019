...
/**
 * 
 * This is Tournament class which extends MapGeo
 * 
 * @author f_yazdan
 * @author s_shehna
 * @author AdinAshby
...
public class Tournament implements Serializable {
	...
	public Tournament(ArrayList<String> listOfMapFiles, ArrayList<String> listOfPlayerStrategies, int numberOfGames,
	...
	public void startTheTournament() {
		...
		mapView.showTournamentResult(results, numberOfGames, games, listOfMapFiles, listOfPlayerStrategies,
				maxNumberOfTurns);
