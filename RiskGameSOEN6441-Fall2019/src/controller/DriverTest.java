...
// load map
		...
		String regex = "loadmap ([\\w*\\_\\-]*)";
		Pattern pattern = Pattern.compile(regex);
		while (mapNotFound == false) {
			String inputLoadMap = in.nextLine();

			Matcher matcher = pattern.matcher(inputLoadMap);
			...
			if (mapFileName != null) {
				...
				System.out.println("Please use 'loadmap filename' format ");
			}
		}
...
//
					...
					int inputEditInt = Integer.parseInt(br.readLine());
					// int inputEditInt = in.nextInt(); ||( inputEditInt==2))
...
//							 String regex = "-add";
//							 Pattern pattern = Pattern.compile(regex); 
//							 Matcher matcher = pattern.matcher(editContinentInput); 
//							 System.out.println( matcher.pattern());
					}
//							//pattern regex 
//							String patternString = "(\\-add\\]\\s)";
...
//					
//
//					 else if (inputEditString.equals("editcountry")) {
////
//					} else if (inputEditString.equals("editneighbor")) {
////
//					} else if (inputEditString.equals("showmap")) {
//

//
//					 switch (inputEditString) {
//					 case "editcontinent" :
//					 break;case "editcountry" :
//					 break;case "editneighbor" :
//					 break;case "showmap" :}
				}

				catch (Exception e) {
					System.out.println(" you have to let us know whether you want to edit or not by ' YES ' or ' Y '");
				}
